      ...
      <div className="mx-auto grid w-full max-w-(--container-max) grid-cols-1 gap-12 px-6 md:px-12 lg:grid-cols-[minmax(0,0.75fr)_minmax(0,1.25fr)] lg:gap-20">
        <Reveal>
          <div className="lg:sticky lg:top-32">
            ...
            >
              Still deciding? These are the questions we field most often
              before an event goes into planning.
            </p>
            <div
            ...
            {FAQS.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* 0fr → 1fr animates to the answer's own height, so nothing
                      has to be measured in JS. */}
                  <div
                    id={`faq-panel-${index}`}
                    role="region"
